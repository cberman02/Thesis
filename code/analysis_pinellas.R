...
#https://www.masstransitmag.com/alt-mobility/shared-mobility/car-sharing/press-release/12296934/pinellas-suncoast-transit-authority-psta-psta-brings-together-uber-and-taxi-to-get-people-on-the-bus
didreg <- feols(
...
write_csv(analysis_fl, "data/census_transit_fl.csv")
